...
-- This script creates a new admin user with a secure password and ensures all necessary tables exist

DO $$
DECLARE
    admin_email TEXT := 'secure_admin@handywriterz.com';
    admin_password TEXT := 'SecureAdm1n@' || floor(random() * 10000)::text; -- Random secure password
    admin_id UUID;
    admin_users_exists BOOLEAN;
    profiles_exists BOOLEAN;
BEGIN
    RAISE NOTICE '======== CREATING SECURE ADMIN USER ========';
    ...
    RAISE NOTICE 'You can now log in with this admin account';
END $$; 